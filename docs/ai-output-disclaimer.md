...
## 1) Purpose and Scope
- Clarifies that outputs come from third-party AI models you choose and configure.
...
- "Models/Providers": Third-party AI services (e.g., Qwen models) that you connect with your own credentials.
- "Outputs": Any audio, text, images, or tool actions generated or triggered by the models.
- "You": Any user, administrator, or organization using or distributing the App.

## 3) Nature of the Service
- The App helps you compose and send requests to models you select.
- You supply and control your own model checkpoints, API keys, and provider choices.
